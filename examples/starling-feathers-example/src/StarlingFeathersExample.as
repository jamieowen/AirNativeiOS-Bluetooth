package {
	...
	public class StarlingFeathersExample extends Sprite
	{
		public static var IS_TEST:Boolean = false;
		
		public function StarlingFeathersExample()
		{
			if(this.stage)
			{
			...
			if( DeviceCapabilities.dpi == 72 )
			{
				DeviceCapabilities.dpi = 326;
				DeviceCapabilities.screenPixelWidth = 640;
				DeviceCapabilities.screenPixelHeight = 960;
